    ...
    <div class="dashboard">
        ...
        <div class="candidate-card">
            <div class="candidate-info">
                <img src="../Voting Pages/img/nyangu.jpg" alt="councillor1">
                <div>
        ...
        <div class="candidate-card">
            <div class="candidate-info">
                <img src="../Voting Pages/img/jane.jpg" alt="Pr. councillor2 Spade">
                <div>
        ...
        <div class="candidate-card">
            <div class="candidate-info">
                <img src="../Voting Pages/img/lewis.jpg" alt="councillor3">
                <div>
